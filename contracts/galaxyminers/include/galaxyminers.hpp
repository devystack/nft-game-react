...
//////////////////////////////////////////////////////////////////
  ...
  TABLE tmconf_table {
    ...
    std::uint8_t additional_tools;
    std::uint16_t additional_energy;
    std::uint8_t shard_production;
    ...
    EOSLIB_SERIALIZE(tmconf_table, (name)(template_id)(type)(img)(badge_img)(saved_claims)(additional_tools)(additional_energy)(shard_production)(rewards_rate)(lucky)(mints)(unstaking_time)(charged_time));
  };
  ...
  TABLE tmcraft_table {
    ...
    EOSLIB_SERIALIZE(tmcraft_table, (id)(name)(img)(saved_claims)(additional_tools)(additional_energy)(shard_production)(rewards_rate)(lucky)(mints)(unstaking_time)(charged_time));
  };
...
//////////////////////////////////////////////////////////////////
  ...
  // set mbsconf
  [[eosio::action]] void settmconf(std::string name, std::uint32_t template_id, std::string type, std::string img, std::string badge_img, std::uint8_t saved_claims, std::uint8_t additional_tools, std::uint16_t additional_energy, std::uint8_t shard_production, std::uint8_t rewards_rate, std::uint8_t lucky, std::vector<eosio::asset> mints, std::uint64_t unstaking_time, std::uint64_t charged_time);
  // remove mbsconf
  [[eosio::action]] void deltmconf(std::uint32_t template_id);

   // set tmcraft
  [[eosio::action]] void settmcraft(std:: uint32_t id, std::string name, std::string img, std::uint8_t saved_claims, std::uint8_t additional_tools, std::uint16_t additional_energy, std::uint8_t shard_production, std::uint8_t rewards_rate, std::uint8_t lucky, std::vector<eosio::asset> mints, std::uint64_t unstaking_time, std::uint64_t charged_time);
...
//////////////////////////////////////////////////////////////////
  ...
  typedef eosio::multi_index<eosio::name{"tmconfig"}, nicegm::tmconf_table> tmconfig;
  typedef eosio::multi_index<eosio::name{"tmcraft"}, nicegm::tmcraft_table> tmcraft;
